...
var commands = exports.commands = {
	...
	ayudaclan: function () {
		if (!this.canBroadcast()) return false;
		this.sendReplyBox(
			"<big><b><font color=green>Comandos informativos:</font></b></big><br /><br />" +
			"<b>/clanes</b> - muestra la lista de clanes registrados.<br />" +
			"<b>/clan [clan]</b> - muestra la información de un clan.<br />" +
			"<b>/miembrosclan [clan]</b> - muestra la lista de miembros de un clan.<br />" +
			"<b>/clanauth [clan]</b> - muestra las autoridades de un clan.<br />" +
			"<b>/warlog [clan]</b> - muestra las guerras en las que un clan participó.<br />" +
			"<br />" +
			"<big><b><font color=green>Comandos básicos:</font></b></big><br /><br />" +
                        "<b>/aceptarclan [clan]</b> - acepta la invitación de un clan para que te unas.<br />" +
                        "<b>/salirclan</b> - abandona tu clan actual.<br />" +
                        "<b>/invitacionesclan [clan]</b> - muestra a los usuarios invitados a un clan.<br />" +
                        "<br />" +
                        "<big><b><font color=green>Comandos administrativos:</font></b></big><br /><br />" +
                        "<b><font size=1><font color=blue>(Requieren ser al menos oficial de clan)</font></color></b><br />" +
                        "<b>/invitarclan [usuario]</b> - invita a alguien a unirse al clan.<br />" +
			"<b>/expulsarclan [usuario]</b> - expulsa a un miembro del clan.<br />" +
                        "<b>/oficialclan [usuario]</b> - promueve a alguien como oficial del clan.<br />" +
			"<b>/demoteclan [usuario]</b> - borra a un miembro del staff del clan.<br />" +
                        "<b>/borrarinvitaciones</b> - borra las invitaciones pendientes al clan.<br />" +
			"<b>/lemaclan [lema]</b> - establece el lema del clan.<br />" +
			"<b>/logoclan [logo]</b> - establece el logo del clan.<br />" +
			"<b>/closeclanroom</b> - bloquea una sala de clan a todos los que no sean miembros de dicho clan, salvo administradores.<br />" +
			"<b>/openclanroom</b> - elimina el bloqueo.<br />" +
                        "<br />" +
                        "<big><b><font color=green>Otros comandos administrativos:</font></b></big><br /><br />" +
                        "<b><font size=1><font color=blue>(Requiere ~)</font></color></b><br />" +
                        "<b>/liderclan [miembro]</b> - nombra a un miembro líder del clan.<br />" +
			"<b>/crearclan [nombre]</b> - crea un clan.<br />" +
			"<b>/borrarclan [nombre]</b> - elimina un clan.<br />" +
			"<b>/addclanmember [clan], [usuario]</b> - fuerza a un usuario a unirse a un clan.<br />" +
			"<b>/removeclanmember [clan], [usuario]</b> - expulsa a un usuario del clan.<br />" +
			"<b>/setlemaclan [clan], [lema]</b> - establece un lema para un clan.<br />" +
			"<b>/setlogoclan [clan], [logo]</b> - establece un logo para un clan.<br />" +
			"<b>/setsalaclan [clan], [sala]</b> - establece una sala para un clan.<br />" +
			"<b>/setgxeclan [clan], [ganadas], [perdidas], [draws]</b> - establece la puntuación de un clan.<br />" +
			"<b>/setrankclan [clan], [puntos]</b> - establece el ranking de un clan.<br />" +
                        "<b>/settitleclan [clan]</b> - establece un titulo para un clan.<br />" +
			"<br />" +
			"<big><b><font color=green>Comandos de Wars:</font></b></big><br /><br />" +
                        "<b><font size=1><font color=blue>(Requieren ser al menos +)</font></color></b><br />" +
			"<b>/war [formato], [tamaño], [clan1], [clan2]</b> - inicia una war entre 2 clanes.<br />" +
			"<b>/totalwar [formato], [tamaño], [clan1], [clan2]</b> - inicia una war total entre 2 clanes.<br />" +
			"<b>/endwar</b> - finaliza una war.<br />" +
			"<b>/vw</b> - muestra el estado de la war.<br />" +
			"<b>/joinwar</b> - comando para unirse a una war.<br />" +
			"<b>/leavewar</b> - comando para salir de una war.<br />" +
			"<b>/warkick [usuario]</b> - fuerza a un usuario a abandonar una war.<br />" +
			"<b>/wardq [usuario]</b> - descalifica a un usuario.<br />" +
		        "<b>/warreplace [usuario1], [usuario2]</b> - comando para reemplazar.<br />" +
			"<b>/warinvalidate [usuario]</b> - deniega la validez de una batalla o un resultado.<br />" +
		);
	},
	...
	borrarclan: function (target) {
		...
		if (!Clans.deleteClan(target))
			this.sendReply("No se pudo eliminar el clan. Es posible que no exista o que se encuentre en war.");
		else
	...
	clanes: 'getclans',
	getclan: 'getclans',
	getclans: function (target, room, user) {
		if (!this.canBroadcast()) return false;
		...
		var clansTable = '<br /><center><big><big><strong>' + clansTableTitle + '</strong></big></big><center><br /><table class="clanstable" width="100%" border="1"><tr><td><center><strong>Clan</strong></center></td><td><center><strong>Miembros</strong></center></td><td><center><strong>Sala</strong></center></td><td><center><strong>Pts Estándar</strong></center></td><td><center><strong>Puntuaci&oacute;n</strong></center></td></tr>';
	...
	clanauth: function (target, room, user) {
		...
		this.sendReplyBox(
			"<center><big><big><b>Jerarquía de autoridades de " + Tools.escapeHTML(Clans.getClanName(target)) + "</b></big></big> <br /><br />" + leaderClanSource + oficialClanSource + memberClanSource + '</center>'
		);
	},
	...
	wartotal: function (target, room, user) {
		...
		if (!Clans.createWar(params[2], params[3], room.id, params[0], params[1], 2)) {
			...
			this.logModCommand(user.name + " ha iniciado una guerra total entre los clanes " + Clans.getClanName(params[2]) + " y " + Clans.getClanName(params[3]) + " en formato " + Clans.getWarFormatName(params[0]) + ".");
